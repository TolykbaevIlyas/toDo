...
const SwitchThemeButton = () => {
  ...
  return (
    ...
    <div className='flex'>
        <button className='px-4 py-2 bg-orange-700 ml-4 rounded-2xl hover:bg-slate-500' type='button' onClick={()=> dispatch(ChangeTheme('default'))}>default Theme</button>
        <button className='px-4 py-2 bg-orange-700 ml-4 rounded-2xl hover:bg-slate-500' type='button' onClick={()=> dispatch(ChangeTheme('second'))}>Second Theme</button>
        <button className='px-4 py-2 bg-orange-700 ml-4 rounded-2xl hover:bg-slate-500' type='button' onClick={()=> dispatch(ChangeTheme('third'))}>Third Theme</button>
    </div>
    :null}
    </div>
  )
